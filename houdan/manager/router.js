...
export const menu = [
  ...
  { path: '/stats-center',  name: 'stats-center',  title: '统计中心',   icon: '▤', adminOnly: true },
  { path: '/staffs',        name: 'staffs',        title: '工作人员',   icon: '☻', adminOnly: true },
...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/stats-center',  component: loadVue('/manager-assets/pages/StatsCenter.vue'),   meta: { requiresAuth: true, adminOnly: true, title: '统计中心' } },
    { path: '/staffs',        component: loadVue('/manager-assets/pages/Staffs.vue'),        meta: { requiresAuth: true, adminOnly: true, title: '工作人员' } },
