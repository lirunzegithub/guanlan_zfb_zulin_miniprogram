...
export const menu = [
  ...
  { path: '/stats-center',  name: 'stats-center',  title: '统计中心',   icon: '▤' },
...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/stats-center',  component: loadVue('/manager-assets/pages/StatsCenter.vue'),   meta: { requiresAuth: true, title: '统计中心' } },
